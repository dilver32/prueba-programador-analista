...
use App\Filament\Resources\Emergencies\Pages\ViewEmergency;
use App\Filament\Resources\Emergencies\Schemas\EmergencyForm;
use App\Filament\Resources\Emergencies\Schemas\EmergencyInfolist;
...
class EmergencyResource extends Resource
{
    ...
    {
        return EmergencyInfolist::configure($schema);
    }
    ...
    {
        return [
           // 'stations' => RelationManagers\StationsRelationManager::class,
        ];
    }
    ...
    public static function getPages(): array
    {
        return [
            ...
            'view' => ViewEmergency::route('/{record}'),
